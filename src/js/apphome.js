...
if(logado === 'gabriel') {
  ...
  `<a href="./pages/adm.html">${logado}</a> <h3><a href="./pages/login.html" id="logout">Sair</a></h3>`;

}  else if(logado) {
  document.querySelector('.logado').innerHTML = 
  `<a href="./pages/carrinho-cliente.html">${logado}</a>  <h3><a href="./pages/login.html" id="logout">Sair</a></h3>`;
