...
if(logado == 'Admin') {
  ...
  `<a href="./pages/adm.html">Admin</a> <h3><a href="./pages/login.html" id="logout">Sair</a></h3>`;

}  else if(logado == 'Usuario') {
  document.querySelector('.logado').innerHTML = 
  `<a href="./pages/carrinho-cliente.html">Usuario 1</a>  <h3><a href="./pages/login.html" id="logout">Sair</a></h3>`;
...
btnFinalizar.addEventListener('click', () => {
  ...
  if (totalCompraNum === 0) {
    ...
    setInteval(alert('Compra adicionada ao carrinho!'))
  }
});