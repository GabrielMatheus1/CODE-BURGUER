...
function listaProdutos() {
	...
	.then(res => res.json()).then(data => {
      ...
      <div class="cards  add-item-carrinho">
        ...
        <img src="${prod.img_url}" alt="Imagem do produto" class="imgs-cards">
        <h3>${prod.produto}</h3>
      ...
      } else if(prod.categoria === 'Sobremesa') {
